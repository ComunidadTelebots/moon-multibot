...
export function createFleetVehicle({THREE:T,descriptor,qualityLevel=2,liveryVariant=0}){
  ...
  if(descriptor.kind==="helicopter"){add(new T.SphereGeometry(1.35,qualityLevel>1?24:14,12),body,[0,.8,0],[],[1,.72,1.55]);add(new T.CylinderGeometry(.18,.38,5,10),body,[0,.8,3],[Math.PI/2,0,0]);add(new T.BoxGeometry(7,.08,.3),dark,[0,2.1,0]);add(new T.BoxGeometry(.1,3,.25),dark,[0,.8,5.4]);add(new T.SphereGeometry(1.05,18,10),glass,[0,.95,-1.35],[],[1,.62,.6]);}
