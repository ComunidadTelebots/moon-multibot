...
MANIFEST=[{"release_channel": "rc", "id":fid,"module":"resource_drift_impact_engines.py","api":api,"capability":api.replace("_"," "),"test":"tests/test_resource_drift_impact_engines.py","preflight":"Moonbot catalog proposed; rg found no matching resource schema and decision"} for fid,api in zip(e.IDS,APIS)]
