...
build_section = """## [v18.25.15.17-alpha] - 2026-08-19 (Registro Diario de Builds)

**Build 17** (`b491c84`): Estructuración del Changelog para reflejar conteo de compilaciones diarias y tags de 4 bloques.
**Build 16** (`7c23dbb`): Sellado y registro oficial de versión alfa tras separar entornos estable/beta/rc.
...
# Reemplazamos la seccion del dia 19
content = re.sub(
